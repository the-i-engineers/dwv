...
QUnit.test('Test Image append slice.', function (assert) {
  ...
  // image 0
  var image0 = new dwv.image.Image(imgGeometry0, [[buffer1, buffer2]], 1, ['0']);
  // append null
  ...
  var image1 = new dwv.image.Image(imgGeometry1, [[buffer1, buffer2]], 1, ['0']);
  ...
  var image2 = new dwv.image.Image(imgGeometry2, [[buffer1, buffer2]], 1, ['0']);
